...
FCOLP.localizationVars.localizationAll = {
    ...
    [1] = {
		...
		["options_show_chamber_resolved_green_springs"]	= "Color chamber springs",
		["options_show_chamber_resolved_green_springs_tooltip"] = "Colorize the springs of the lock if the chamber is resolved.",
		["options_show_chamber_resolved_green_springs_color"] = "Springs color",
		["options_show_chamber_resolved_green_springs_color_tooltip"] = "Choose the color of the resolved springs",
		...
		["options_show_chamber_resolved_icon_color"] = "Chamber resolved texture color",
		["options_show_chamber_resolved_icon_color_tooltip"] = "Choose the color of the chamber resolved texture",
		["options_chamber_resolved_icon"] = "Chamber resolved texture",
...
--==============================================================================
    ...
    [2] = {
        ...
        ["options_show_chamber_resolved_green_springs"]	= "Färbe Schloss Federn",
        ["options_show_chamber_resolved_green_springs_tooltip"] = "Färbe die Federn des Schlosses, wenn eine Kammer gelöst wurde.",
		["options_show_chamber_resolved_green_springs_color"] = "Federn Farbe",
		["options_show_chamber_resolved_green_springs_color_tooltip"] = "Wähle die Farbe für die gelösten Federn",
		...
		["options_show_chamber_resolved_icon_color"] = "Kammer gelöst Symbol Farbe",
		["options_show_chamber_resolved_icon_color_tooltip"] = "Wähle die Farbe für das Symbol, welches dir anzeigt, dass die Kammer gelöst wurde",
		["options_chamber_resolved_icon"] = "Kammer gelöst Symbol",
